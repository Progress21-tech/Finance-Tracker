        ...
        >
          <div className="glass-light rounded-3xl p-8 shadow-glass">
            <div className="text-center mb-8">
              <h1 className="font-display font-bold text-2xl text-[var(--text)] mb-1">Create your account</h1>
              <p className="text-sm text-[var(--text-muted)]">Free during beta — no card needed</p>
            </div>
            ...
            <p className="text-center text-xs text-[var(--text-subtle)] mt-6">
              ...
              <Link to="/login" className="text-quillio-400 hover:text-quillio-300 transition-colors font-medium">
                Log in
              </Link>
            </p>
          </div>
